...
export default function CreateAccount() {
  ...
  return (
    <div className="min-h-screen bg-[#2C024D]">
      {/* Header */}
      ...
      <div className="relative">
        <div className="bg-gray-200 rounded-t-[32px] pt-8 px-4 sm:px-6 lg:px-8 pb-10">
          <div className="max-w-md mx-auto lg:max-w-2xl">
            <div className=" rounded-xl  p-6 sm:p-8 space-y-8">
              ...
              <div className="pt-6 w-[50%] mx-auto ">
                <div className="bg-[#A29696] py-4 px-4 flex rounded-lg items-center justify-center">
