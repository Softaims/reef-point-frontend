...
export default function SplashScreen() {
  return (
    <div className="bg-[#2C024D]">
      <div className=" flex flex-col justify-between px-6 pt-10 pb-0 mb-0">
      ...
      <div className="flex justify-center items-end overflow-hidden">
        <img
          src={splashScreen}
          alt="Underwater Reef"
          className="w-[100%] h-full scale-140 md:scale-100  origin-center transform translate-y-[15%] md:translate-0" // Moves the image outside of the container
        />
      </div>
    </div>
  );
