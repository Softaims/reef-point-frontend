          ...
          <div className="rounded-xl py-6 px-2 sm:py-8 space-y-8">
            ...
            <div className="pt-8 w-[60%] mx-auto">
              <Link to="/create-account/step-2">
                <button
                  type="button"
                  className="w-full bg-[#A29696] hover:bg-[#8B7C7C] text-black font-medium text-lg h-[50px] px-6 rounded-lg transition duration-200 transform hover:scale-105 active:scale-95"
                >
                  Claim
                </button>
              </Link>
